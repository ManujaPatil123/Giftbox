<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="Online_shop.SignIn" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorUserName" runat="server" Cssclass="text-danger" ErrorMessage="Please Enter UserName" ControlToValidate="txtUsername" ForeColor="#CC0000"></asp:RequiredFieldValidator>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:TextBox ID="txtPassword" CssClass="form-control" runat="server" TextMode="Password"></asp:TextBox>
                         <asp:RequiredFieldValidator ID="RequiredFieldValidatorPassword" runat="server" Cssclass="text-danger" ErrorMessage="Please Enter Valid Password" ControlToValidate="txtPassword" ForeColor="#CC0000"></asp:RequiredFieldValidator>
